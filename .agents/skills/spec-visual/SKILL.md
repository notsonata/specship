...
5. **Close deliberately.** Continue until every material branch has been visited and nothing remains silently assumed. Summarize the resulting shared understanding and ask the user to confirm it before patching visuals, changing scope, assigning a finding, or accepting a correction.
